...
void PMOD_SWT_Init()
{
    P10->SEL0 &= ~0xF;       //P10.0, P10.1, P10.2 and P10.3 = 111b = 0xF
    P10->SEL1 &= ~0xF;
    P10->DIR &= ~0xF;
    P10->REN |= 0xF;         //Enable internal resistor
    P10->OUT &= ~0xF;        //PullUp when Bit is Set to 1 and PullDOwn when Bit is set to 0(clear)
}
